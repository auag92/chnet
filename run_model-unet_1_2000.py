...
def main():
    ...
    fname = "out/unet_model_ch{}_{}_{}_longrun.pt".format(ngf, 
                                                  init_steps, 
                                                  delta_sim_steps)
    ...
    count = 0
    for seed_trn in [23513*29, 124081*17, 1982981*31, 1783*19, 8574*23, 2364*93, 871523*113, 8961*43, 98712*73, 14112*31]:
